...
import instLogo from '@salesforce/resourceUrl/TwitterIcon';
...
export default class TwitterHandler extends LightningElement {
    ...
    serverResponse({ error, data }) {
        ...
        if (data) {
           ...
           this.tweetDescription=this.serverResponseData[0].postCaption;
           this.postUrl=this.serverResponseData[0].PostUrl;
